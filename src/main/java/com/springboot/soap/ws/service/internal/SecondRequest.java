...
/**
 * <p>Java class for secondRequest complex type.
 * 
...
@XmlType(name = "secondRequest", propOrder = {
    "id",
    "paramFields"
})
@XmlRootElement(name = "secondRequest", namespace = "http://schemas.soapws.com/test/ws/soapws")
