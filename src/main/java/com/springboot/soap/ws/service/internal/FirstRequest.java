...
/**
 * <p>Java class for firstRequest complex type.
 * 
...
@XmlType(name = "firstRequest", propOrder = {
    "name",
    "lastname",
    "email",
    "status",
...
@XmlRootElement(name = "firstRequest", namespace = "http://schemas.soapws.com/test/ws/soapws")
